#!/bin/bash
# =============================================================================
# F1-SGD: FedAvg system eval with SGD optimizer.
# Mirrors the F1 experiment from multiple_jobs_system.sh (B=8192, C=0.1,
...
# Walltime: 12 h (same as other FedAvg system jobs).
# =============================================================================
