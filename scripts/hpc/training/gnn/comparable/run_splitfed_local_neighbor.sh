#!/bin/bash
# =============================================================================
# SplitFed with local_neighbor batching — seed 1 benchmark.
#
...
# unlike lazy_link_neighbor which samples the global graph and filters.
#
# Comparison target: lazy_link_neighbor at ~28 min/epoch (~23h for 50 rounds).
# lazy_link_neighbor walltime used as baseline; extend if setup is slower.
# =============================================================================
# Usage:
#   bash scripts/hpc/training/gnn/comparable/run_splitfed_local_neighbor.sh
# =============================================================================
...
--max_workers $CPUS --testing_seeds 1 --batching_mode local_neighbor --num_rounds 50"

RUN_ID=$(date +%Y%m%d_%H%M%S)

mkdir -p logs

JOB_NAME="aml_splitfed_local_nb_s1"
...
echo 'SplitFed local_neighbor — seed 1 (run_id=$RUN_ID)'
echo '======================================================================'
