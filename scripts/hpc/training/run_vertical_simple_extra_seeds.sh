#!/bin/bash
# =============================================================================
# Submit additional FedGraphSimple seed jobs into an existing run directory.
#
# Usage:
#   bash scripts/hpc/training/run_vertical_simple_extra_seeds.sh <RUN_ID> <FIRST_SEED> <LAST_SEED>
#
# Example — add seeds 3 and 4 to an existing run:
#   bash scripts/hpc/training/run_vertical_simple_extra_seeds.sh 20250501_143022 3 4
# =============================================================================
...
for SEED in $(seq $FIRST_SEED $LAST_SEED); do
    JOB_NAME="aml_fedgraphsimple_lazy_s${SEED}"
...
echo 'FedGraphSimple lazy — seed $SEED (run_id=$RUN_ID)'
echo '======================================================================'
...
echo ""
echo "Submitted seeds $FIRST_SEED-$LAST_SEED into existing run directory (run_id=$RUN_ID)."
