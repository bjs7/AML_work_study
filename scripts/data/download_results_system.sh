#!/bin/bash
# =============================================================================
# Download system eval mode results from HPC (wice, A100)
# Mirrors experiment list from multiple_jobs_system.sh
# =============================================================================
# Usage:
#   ./download_results_system.sh             # Download all system experiments
#   ./download_results_system.sh --dry-run   # Preview constructed paths
#   ./download_results_system.sh --all       # Download everything under HPC_BASE
# =============================================================================
...
# =============================================================================
# All system-mode experiments (mirrors multiple_jobs_system.sh)
# =============================================================================
EXPERIMENTS=(
...
if [[ "$DOWNLOAD_ALL" == true ]]; then
    ...
    echo "Downloading ${#EXPERIMENTS[@]} system-mode experiments..."
    echo "======================================================================"
    echo ""
